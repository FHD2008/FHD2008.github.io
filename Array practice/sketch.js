...
function setup() {
  ...
  numbers.push([10,20,30]); // STEP 2
  numbers.push([5,5,5]);
  numbers.push([97,98,99]);
  
  print(numbers); //STEP 3
  
  numbers[0].push(99); //STEP 4
  numbers[1].push(99);
  numbers[2].push(99);
                      
  numbers[0][2] = 300; //STEP 5
  
  for (let arrayIndex = 0; arrayIndex < numbers.length; arrayIndex++ ){   //STEP 6
